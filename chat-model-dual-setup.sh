...
open_webui_container_specific_target_host=198.18.13.100    # If using Rootless Docker, this value may need to be changed to the actual target host IP address.
