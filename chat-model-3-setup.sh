...
chat_model_2_name="llama 3.2, 1B"
chat_model_2_huggingface_download_source="meta-llama/Llama-3.2-1B"
...
if $hugging_face_access_token; then
	...
	HF_TOKEN=$hugging_face_access_token HF_HUB_ENABLE_HF_TRANSFER=1 huggingface-cli download $chat_model_3_huggingface_download_source --local-dir $HOME/ai_models/$chat_model_3_huggingface_download_local_sub_directory
else
	...
	HF_HUB_ENABLE_HF_TRANSFER=1 huggingface-cli download $chat_model_3_huggingface_download_source --local-dir $HOME/ai_models/$chat_model_3_huggingface_download_local_sub_directory
fi
